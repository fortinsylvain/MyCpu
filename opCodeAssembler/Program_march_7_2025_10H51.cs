...
//        }
        ...
        static void Main(string[] args)
        {
            ...
            dataList.Add(new InstrTable { StringValue = "EQU", OpCode = 0, NbByte = 0, Offset = 3 });  // Define Byte in EEPROM Memory
                        ...
                        else // Process the line
                        {
                            ...
                            if (bFound)
                            {
                                ...
                                else if (iIndexTable == 2)   // EQU
                                {
                                    ...
                                    int iSymbolAddress = int.Parse(sLine.Substring(iFirstCharacterIndex + 4, 4), System.Globalization.NumberStyles.HexNumber);
